...
function* updatePost(action) {
  console.log('updatePost call', action);
  try {
    const result = yield call(updatePostAPI, action.data); // call 동기함수를 호출하여 결과값을 받아온다
    console.log('updatePost api call', result.data);
    yield put({
